...
export default class RestaurantsDAO {
    ...
    static async getRestaurants({
        ...
        if ( filters) {
            if ("name" in filters) {
                //we set name in mongodb tht if someone does a text search, ehich field will be queried
                ...
                const pipeline= [ //
                    {
                        ...
                        {
                            //from review collection we create a pipeline taht will match the restaurant_id
